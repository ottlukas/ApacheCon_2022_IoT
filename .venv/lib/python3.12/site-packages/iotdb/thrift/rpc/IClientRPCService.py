...
class Iface(object):
    ...
    def executePreparedStatement(self, req):
        """
        Parameters:
         - req
    ...
    def deallocatePreparedStatement(self, req):
        """
        Parameters:
         - req
...
class Client(Iface):
    ...
    def prepareStatement(self, req):
        ...
        """
        self.send_prepareStatement(req)
        return self.recv_prepareStatement()

    def send_prepareStatement(self, req):
    ...
    def executePreparedStatement(self, req):
        ...
        """
        self.send_executePreparedStatement(req)
        return self.recv_executePreparedStatement()

    def send_executePreparedStatement(self, req):
        self._oprot.writeMessageBegin('executePreparedStatement', TMessageType.CALL, self._seqid)
        args = executePreparedStatement_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_executePreparedStatement(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = executePreparedStatement_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "executePreparedStatement failed: unknown result")
    ...
    def deallocatePreparedStatement(self, req):
        ...
        """
        self.send_deallocatePreparedStatement(req)
        return self.recv_deallocatePreparedStatement()

    def send_deallocatePreparedStatement(self, req):
        self._oprot.writeMessageBegin('deallocatePreparedStatement', TMessageType.CALL, self._seqid)
        args = deallocatePreparedStatement_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_deallocatePreparedStatement(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = deallocatePreparedStatement_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "deallocatePreparedStatement failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["executePreparedStatement"] = Processor.process_executePreparedStatement
        self._processMap["deallocatePreparedStatement"] = Processor.process_deallocatePreparedStatement
    ...
    def process_prepareStatement(self, seqid, iprot, oprot):
        ...
        result = prepareStatement_result()
        try:
            result.success = self._handler.prepareStatement(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_executePreparedStatement(self, seqid, iprot, oprot):
        args = executePreparedStatement_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = executePreparedStatement_result()
        try:
            result.success = self._handler.executePreparedStatement(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("executePreparedStatement", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_deallocatePreparedStatement(self, seqid, iprot, oprot):
        args = deallocatePreparedStatement_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = deallocatePreparedStatement_result()
        try:
            result.success = self._handler.deallocatePreparedStatement(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deallocatePreparedStatement", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
prepareStatement_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TSPrepareReq, None], None, ),  # 1
)
...
prepareStatement_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSPrepareResp, None], None, ),  # 0
)


class executePreparedStatement_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executePreparedStatement_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executePreparedStatement_args)
executePreparedStatement_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TSExecutePreparedReq, None], None, ),  # 1
)


class executePreparedStatement_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('executePreparedStatement_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(executePreparedStatement_result)
executePreparedStatement_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TSExecuteStatementResp, None], None, ),  # 0
)


class deallocatePreparedStatement_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TSDeallocatePreparedReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deallocatePreparedStatement_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deallocatePreparedStatement_args)
deallocatePreparedStatement_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TSDeallocatePreparedReq, None], None, ),  # 1
)


class deallocatePreparedStatement_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deallocatePreparedStatement_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deallocatePreparedStatement_result)
deallocatePreparedStatement_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 0
)
...
class deleteStorageGroups_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i684 in range(_size680):
                        ...
                        self.storageGroup.append(_elem685)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.storageGroup is not None:
            ...
            for iter686 in self.storageGroup:
