...
class TSCloseOperationReq(object):
    ...
    def __init__(self, sessionId=None, queryId=None, statementId=None, preparedStatementName=None,):
        self.sessionId = sessionId
        self.queryId = queryId
        self.statementId = statementId
    ...
    def write(self, oprot):
        ...
        if self.preparedStatementName is not None:
            oprot.writeFieldBegin('preparedStatementName', TType.STRING, 4)
...
class TSPrepareReq(object):
    ...
    def __init__(self, sessionId=None, sql=None, statementName=None,):
        self.sessionId = sessionId
        self.sql = sql
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.statementName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TSPrepareReq')
        if self.sessionId is not None:
            oprot.writeFieldBegin('sessionId', TType.I64, 1)
            oprot.writeI64(self.sessionId)
            oprot.writeFieldEnd()
        ...
        if self.statementName is not None:
            oprot.writeFieldBegin('statementName', TType.STRING, 3)
    ...
    def validate(self):
        ...
        if self.statementName is None:
            raise TProtocolException(message='Required field statementName is unset!')
        return
...
class TSPrepareResp(object):
    ...
    def __init__(self, status=None, parameterCount=None,):
        self.status = status
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.parameterCount = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TSPrepareResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
        if self.parameterCount is not None:
            oprot.writeFieldBegin('parameterCount', TType.I32, 2)
            oprot.writeI32(self.parameterCount)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSExecutePreparedReq(object):
    """
    Attributes:
     - sessionId
     - statementName
    ...
    def __init__(self, sessionId=None, statementName=None, parameters=None, fetchSize=None, timeout=None, statementId=None,):
        self.sessionId = sessionId
        self.statementName = statementName
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.parameters = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TSExecutePreparedReq')
        if self.sessionId is not None:
            oprot.writeFieldBegin('sessionId', TType.I64, 1)
            oprot.writeI64(self.sessionId)
            oprot.writeFieldEnd()
        if self.statementName is not None:
            oprot.writeFieldBegin('statementName', TType.STRING, 2)
            oprot.writeString(self.statementName.encode('utf-8') if sys.version_info[0] == 2 else self.statementName)
            oprot.writeFieldEnd()
        if self.parameters is not None:
            oprot.writeFieldBegin('parameters', TType.STRING, 3)
            oprot.writeBinary(self.parameters)
            oprot.writeFieldEnd()
        if self.fetchSize is not None:
            oprot.writeFieldBegin('fetchSize', TType.I32, 4)
            oprot.writeI32(self.fetchSize)
...
class TSDeallocatePreparedReq(object):
    """
    Attributes:
     - sessionId
     - statementName
    ...
    def __init__(self, sessionId=None, statementName=None,):
        self.sessionId = sessionId
        self.statementName = statementName
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TSDeallocatePreparedReq')
        if self.sessionId is not None:
            oprot.writeFieldBegin('sessionId', TType.I64, 1)
            oprot.writeI64(self.sessionId)
            oprot.writeFieldEnd()
...
TSCloseOperationReq.thrift_spec = (
    ...
    (2, TType.I64, 'queryId', None, None, ),  # 2
    (3, TType.I64, 'statementId', None, None, ),  # 3
    (4, TType.STRING, 'preparedStatementName', 'UTF8', None, ),  # 4
)
all_structs.append(TSPrepareReq)
TSPrepareReq.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'sessionId', None, None, ),  # 1
    (2, TType.STRING, 'sql', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'statementName', 'UTF8', None, ),  # 3
)
all_structs.append(TSPrepareResp)
TSPrepareResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.I32, 'parameterCount', None, None, ),  # 2
)
all_structs.append(TSExecutePreparedReq)
TSExecutePreparedReq.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'sessionId', None, None, ),  # 1
    (2, TType.STRING, 'statementName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'parameters', 'BINARY', None, ),  # 3
    (4, TType.I32, 'fetchSize', None, None, ),  # 4
    (5, TType.I64, 'timeout', None, None, ),  # 5
    (6, TType.I64, 'statementId', None, None, ),  # 6
)
all_structs.append(TSDeallocatePreparedReq)
TSDeallocatePreparedReq.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'sessionId', None, None, ),  # 1
    (2, TType.STRING, 'statementName', 'UTF8', None, ),  # 2
)
