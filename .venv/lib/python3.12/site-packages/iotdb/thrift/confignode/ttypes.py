...
class TAuditConfig(object):
    """
    Attributes:
     - enableAuditLog
     - auditableOperationType
    ...
    def __init__(self, enableAuditLog=None, auditableOperationType=None, auditableOperationLevel=None, auditableOperationResult=None,):
        self.enableAuditLog = enableAuditLog
        self.auditableOperationType = auditableOperationType
        self.auditableOperationLevel = auditableOperationLevel
        self.auditableOperationResult = auditableOperationResult
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.BOOL:
                    self.enableAuditLog = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.auditableOperationType = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.auditableOperationLevel = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.auditableOperationResult = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TAuditConfig')
        if self.enableAuditLog is not None:
            oprot.writeFieldBegin('enableAuditLog', TType.BOOL, 1)
            oprot.writeBool(self.enableAuditLog)
            oprot.writeFieldEnd()
        if self.auditableOperationType is not None:
            oprot.writeFieldBegin('auditableOperationType', TType.STRING, 2)
            oprot.writeString(self.auditableOperationType.encode('utf-8') if sys.version_info[0] == 2 else self.auditableOperationType)
            oprot.writeFieldEnd()
        if self.auditableOperationLevel is not None:
            oprot.writeFieldBegin('auditableOperationLevel', TType.STRING, 3)
            oprot.writeString(self.auditableOperationLevel.encode('utf-8') if sys.version_info[0] == 2 else self.auditableOperationLevel)
            oprot.writeFieldEnd()
        if self.auditableOperationResult is not None:
            oprot.writeFieldBegin('auditableOperationResult', TType.STRING, 4)
            oprot.writeString(self.auditableOperationResult.encode('utf-8') if sys.version_info[0] == 2 else self.auditableOperationResult)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.enableAuditLog is None:
            raise TProtocolException(message='Required field enableAuditLog is unset!')
        return
...
class TGlobalConfig(object):
    ...
    def __init__(self, dataRegionConsensusProtocolClass=None, schemaRegionConsensusProtocolClass=None, seriesPartitionSlotNum=None, seriesPartitionExecutorClass=None, timePartitionInterval=None, readConsistencyLevel=None, diskSpaceWarningThreshold=None, enableGrantOption=None, timestampPrecision=None, schemaEngineMode=None, tagAttributeTotalSize=None, isEnterprise=None, timePartitionOrigin=None, restrictObjectLimit=None,):
        ...
        self.enableGrantOption = enableGrantOption
        ...
        self.restrictObjectLimit = restrictObjectLimit
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.enableGrantOption = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRING:
                ...
                if ftype == TType.BOOL:
                    self.restrictObjectLimit = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.diskSpaceWarningThreshold is not None:
            ...
            oprot.writeFieldEnd()
        if self.enableGrantOption is not None:
            oprot.writeFieldBegin('enableGrantOption', TType.BOOL, 8)
            oprot.writeBool(self.enableGrantOption)
            oprot.writeFieldEnd()
        if self.timestampPrecision is not None:
            oprot.writeFieldBegin('timestampPrecision', TType.STRING, 9)
        ...
        if self.schemaEngineMode is not None:
            oprot.writeFieldBegin('schemaEngineMode', TType.STRING, 10)
        ...
        if self.tagAttributeTotalSize is not None:
            oprot.writeFieldBegin('tagAttributeTotalSize', TType.I32, 11)
            oprot.writeI32(self.tagAttributeTotalSize)
            oprot.writeFieldEnd()
        if self.isEnterprise is not None:
            oprot.writeFieldBegin('isEnterprise', TType.BOOL, 12)
            oprot.writeBool(self.isEnterprise)
            oprot.writeFieldEnd()
        if self.timePartitionOrigin is not None:
            oprot.writeFieldBegin('timePartitionOrigin', TType.I64, 13)
            oprot.writeI64(self.timePartitionOrigin)
            oprot.writeFieldEnd()
        if self.restrictObjectLimit is not None:
            oprot.writeFieldBegin('restrictObjectLimit', TType.BOOL, 14)
            oprot.writeBool(self.restrictObjectLimit)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.enableGrantOption is None:
            raise TProtocolException(message='Required field enableGrantOption is unset!')
        return
...
class TRatisConfig(object):
    ...
    def __init__(self, schemaAppenderBufferSize=None, dataAppenderBufferSize=None, schemaSnapshotTriggerThreshold=None, dataSnapshotTriggerThreshold=None, schemaLogUnsafeFlushEnable=None, dataLogUnsafeFlushEnable=None, schemaLogSegmentSizeMax=None, dataLogSegmentSizeMax=None, schemaGrpcFlowControlWindow=None, dataGrpcFlowControlWindow=None, schemaLeaderElectionTimeoutMin=None, dataLeaderElectionTimeoutMin=None, schemaLeaderElectionTimeoutMax=None, dataLeaderElectionTimeoutMax=None, schemaRequestTimeout=None, dataRequestTimeout=None, schemaMaxRetryAttempts=None, dataMaxRetryAttempts=None, schemaInitialSleepTime=None, dataInitialSleepTime=None, schemaMaxSleepTime=None, dataMaxSleepTime=None, schemaPreserveWhenPurge=None, dataPreserveWhenPurge=None, firstElectionTimeoutMin=None, firstElectionTimeoutMax=None, schemaRegionRatisLogMax=None, dataRegionRatisLogMax=None, dataRegionGrpcLeaderOutstandingAppendsMax=None, dataRegionLogForceSyncNum=None, schemaRegionGrpcLeaderOutstandingAppendsMax=None, schemaRegionLogForceSyncNum=None, schemaRegionPeriodicSnapshotInterval=None, dataRegionPeriodicSnapshotInterval=None, ratisTransferLeaderTimeoutMs=None, schemaReconfigurationMaxRetryAttempts=None, dataReconfigurationMaxRetryAttempts=None,):
        ...
        self.ratisTransferLeaderTimeoutMs = ratisTransferLeaderTimeoutMs
        self.schemaReconfigurationMaxRetryAttempts = schemaReconfigurationMaxRetryAttempts
        self.dataReconfigurationMaxRetryAttempts = dataReconfigurationMaxRetryAttempts
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.ratisTransferLeaderTimeoutMs = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 36:
                if ftype == TType.I32:
                    self.schemaReconfigurationMaxRetryAttempts = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 37:
                if ftype == TType.I32:
                    self.dataReconfigurationMaxRetryAttempts = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.dataRegionPeriodicSnapshotInterval is not None:
            ...
            oprot.writeFieldEnd()
        if self.ratisTransferLeaderTimeoutMs is not None:
            oprot.writeFieldBegin('ratisTransferLeaderTimeoutMs', TType.I32, 35)
            oprot.writeI32(self.ratisTransferLeaderTimeoutMs)
            oprot.writeFieldEnd()
        if self.schemaReconfigurationMaxRetryAttempts is not None:
            oprot.writeFieldBegin('schemaReconfigurationMaxRetryAttempts', TType.I32, 36)
            oprot.writeI32(self.schemaReconfigurationMaxRetryAttempts)
            oprot.writeFieldEnd()
        if self.dataReconfigurationMaxRetryAttempts is not None:
            oprot.writeFieldBegin('dataReconfigurationMaxRetryAttempts', TType.I32, 37)
            oprot.writeI32(self.dataReconfigurationMaxRetryAttempts)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.ratisTransferLeaderTimeoutMs is None:
            raise TProtocolException(message='Required field ratisTransferLeaderTimeoutMs is unset!')
        return
...
class TRuntimeConfiguration(object):
    ...
    Attributes:
     ...
     - allUserDefinedServiceInfo

    """


    def __init__(self, templateInfo=None, allTriggerInformation=None, allUDFInformation=None, allTTLInformation=None, allPipeInformation=None, clusterId=None, tableInfo=None, auditConfig=None, superUserName=None, enableSeparationOfAdminPowers=None, allUserDefinedServiceInfo=None,):
        ...
        self.enableSeparationOfAdminPowers = enableSeparationOfAdminPowers
        self.allUserDefinedServiceInfo = allUserDefinedServiceInfo
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.auditConfig = TAuditConfig()
                    self.auditConfig.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRING:
                    self.superUserName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.BOOL:
                    self.enableSeparationOfAdminPowers = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.LIST:
                    self.allUserDefinedServiceInfo = []
                    (_etype21, _size18) = iprot.readListBegin()
                    for _i22 in range(_size18):
                        _elem23 = iotdb.thrift.common.ttypes.TExternalServiceEntry()
                        _elem23.read(iprot)
                        self.allUserDefinedServiceInfo.append(_elem23)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allTriggerInformation is not None:
            ...
            for iter24 in self.allTriggerInformation:
        ...
        if self.allUDFInformation is not None:
            ...
            for iter25 in self.allUDFInformation:
                oprot.writeBinary(iter25)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.allPipeInformation is not None:
            ...
            for iter26 in self.allPipeInformation:
        ...
        if self.tableInfo is not None:
            ...
            oprot.writeFieldEnd()
        if self.auditConfig is not None:
            oprot.writeFieldBegin('auditConfig', TType.STRUCT, 8)
            self.auditConfig.write(oprot)
            oprot.writeFieldEnd()
        if self.superUserName is not None:
            oprot.writeFieldBegin('superUserName', TType.STRING, 9)
            oprot.writeString(self.superUserName.encode('utf-8') if sys.version_info[0] == 2 else self.superUserName)
            oprot.writeFieldEnd()
        if self.enableSeparationOfAdminPowers is not None:
            oprot.writeFieldBegin('enableSeparationOfAdminPowers', TType.BOOL, 10)
            oprot.writeBool(self.enableSeparationOfAdminPowers)
            oprot.writeFieldEnd()
        if self.allUserDefinedServiceInfo is not None:
            oprot.writeFieldBegin('allUserDefinedServiceInfo', TType.LIST, 11)
            oprot.writeListBegin(TType.STRUCT, len(self.allUserDefinedServiceInfo))
            for iter27 in self.allUserDefinedServiceInfo:
                iter27.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def validate(self):
        ...
        if self.auditConfig is None:
            raise TProtocolException(message='Required field auditConfig is unset!')
        if self.superUserName is None:
            raise TProtocolException(message='Required field superUserName is unset!')
        return
...
class TDataNodeRestartResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i39 in range(_size35):
                        _elem40 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem40.read(iprot)
                        self.configNodeList.append(_elem40)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i45 in range(_size41):
                        _elem46 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _elem46.read(iprot)
                        self.correctConsensusGroups.append(_elem46)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter47 in self.configNodeList:
                iter47.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.runtimeConfiguration is not None:
        ...
        if self.correctConsensusGroups is not None:
            ...
            for iter48 in self.correctConsensusGroups:
                iter48.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TDataNodeRemoveReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i53 in range(_size49):
                        _elem54 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _elem54.read(iprot)
                        self.dataNodeLocations.append(_elem54)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodeLocations is not None:
            ...
            for iter55 in self.dataNodeLocations:
                iter55.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TDataNodeRemoveResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i60 in range(_size56):
                        _key61 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _key61.read(iprot)
                        _val62 = iotdb.thrift.common.ttypes.TSStatus()
                        _val62.read(iprot)
                        self.nodeToStatus[_key61] = _val62
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.nodeToStatus is not None:
            ...
            for kiter63, viter64 in self.nodeToStatus.items():
                kiter63.write(oprot)
                viter64.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TDataNodeConfigurationResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i69 in range(_size65):
                        ...
                        _val71 = iotdb.thrift.common.ttypes.TDataNodeConfiguration()
                        _val71.read(iprot)
                        self.dataNodeConfigurationMap[_key70] = _val71
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodeConfigurationMap is not None:
            ...
            for kiter72, viter73 in self.dataNodeConfigurationMap.items():
...
class TDeleteDatabasesReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i78 in range(_size74):
                        ...
                        self.prefixPathList.append(_elem79)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.prefixPathList is not None:
            ...
            for iter80 in self.prefixPathList:
...
class TDatabaseSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i85 in range(_size81):
                        ...
                        _val87 = TDatabaseSchema()
                        _val87.read(iprot)
                        self.databaseSchemaMap[_key86] = _val87
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseSchemaMap is not None:
            ...
            for kiter88, viter89 in self.databaseSchemaMap.items():
...
class TSchemaPartitionTableResp(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i103 in range(_size99):
                        ...
                        for _i110 in range(_size106):
                            _key111 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _key111.read(iprot)
                            _val112 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                            _val112.read(iprot)
                            _val105[_key111] = _val112
                        iprot.readMapEnd()
                        self.schemaPartitionTable[_key104] = _val105
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaPartitionTable is not None:
            ...
            for kiter113, viter114 in self.schemaPartitionTable.items():
                oprot.writeString(kiter113.encode('utf-8') if sys.version_info[0] == 2 else kiter113)
                oprot.writeMapBegin(TType.STRUCT, TType.STRUCT, len(viter114))
                for kiter115, viter116 in viter114.items():
                    kiter115.write(oprot)
...
class TSchemaNodeManagementReq(object):
    ...
    def __init__(self, pathPatternTree=None, level=None, scopePatternTree=None, needAuditDB=None,):
        self.pathPatternTree = pathPatternTree
        self.level = level
        self.scopePatternTree = scopePatternTree
        self.needAuditDB = needAuditDB
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.needAuditDB = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.scopePatternTree is not None:
            ...
            oprot.writeFieldEnd()
        if self.needAuditDB is not None:
            oprot.writeFieldBegin('needAuditDB', TType.BOOL, 4)
            oprot.writeBool(self.needAuditDB)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSchemaNodeManagementResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i121 in range(_size117):
                        ...
                        for _i128 in range(_size124):
                            _key129 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _key129.read(iprot)
                            _val130 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                            _val130.read(iprot)
                            _val123[_key129] = _val130
                        iprot.readMapEnd()
                        self.schemaRegionMap[_key122] = _val123
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.SET:
                    ...
                    for _i135 in range(_size131):
                        _elem136 = iotdb.thrift.common.ttypes.TSchemaNode()
                        _elem136.read(iprot)
                        self.matchedNode.add(_elem136)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.schemaRegionMap is not None:
            ...
            for kiter137, viter138 in self.schemaRegionMap.items():
                oprot.writeString(kiter137.encode('utf-8') if sys.version_info[0] == 2 else kiter137)
                oprot.writeMapBegin(TType.STRUCT, TType.STRUCT, len(viter138))
                for kiter139, viter140 in viter138.items():
                    kiter139.write(oprot)
        ...
        if self.matchedNode is not None:
            ...
            for iter141 in self.matchedNode:
                iter141.write(oprot)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TTimeSlotList(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i146 in range(_size142):
                        _elem147 = iotdb.thrift.common.ttypes.TTimePartitionSlot()
                        _elem147.read(iprot)
                        self.timePartitionSlots.append(_elem147)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.timePartitionSlots is not None:
            ...
            for iter148 in self.timePartitionSlots:
                iter148.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TDataPartitionReq(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i153 in range(_size149):
                        _key154 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val155 = {}
                        (_ktype157, _vtype158, _size156) = iprot.readMapBegin()
                        for _i160 in range(_size156):
                            _key161 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _key161.read(iprot)
                            _val162 = TTimeSlotList()
                            _val162.read(iprot)
                            _val155[_key161] = _val162
                        iprot.readMapEnd()
                        self.partitionSlotsMap[_key154] = _val155
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partitionSlotsMap is not None:
            ...
            for kiter163, viter164 in self.partitionSlotsMap.items():
                oprot.writeString(kiter163.encode('utf-8') if sys.version_info[0] == 2 else kiter163)
                oprot.writeMapBegin(TType.STRUCT, TType.STRUCT, len(viter164))
...
class TDataPartitionTableResp(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i171 in range(_size167):
                        ...
                        for _i178 in range(_size174):
                            _key179 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                            _key179.read(iprot)
                            _val180 = {}
                            (_ktype182, _vtype183, _size181) = iprot.readMapBegin()
                            for _i185 in range(_size181):
                                _key186 = iotdb.thrift.common.ttypes.TTimePartitionSlot()
                                _key186.read(iprot)
                                _val187 = []
                                (_etype191, _size188) = iprot.readListBegin()
                                for _i192 in range(_size188):
                                    _elem193 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                                    _elem193.read(iprot)
                        ...
                        iprot.readMapEnd()
                        self.dataPartitionTable[_key172] = _val173
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataPartitionTable is not None:
            ...
            for kiter194, viter195 in self.dataPartitionTable.items():
                oprot.writeString(kiter194.encode('utf-8') if sys.version_info[0] == 2 else kiter194)
                oprot.writeMapBegin(TType.STRUCT, TType.MAP, len(viter195))
                for kiter196, viter197 in viter195.items():
                    kiter196.write(oprot)
                    oprot.writeMapBegin(TType.STRUCT, TType.LIST, len(viter197))
                    for kiter198, viter199 in viter197.items():
                        kiter198.write(oprot)
                        oprot.writeListBegin(TType.STRUCT, len(viter199))
...
class TGetRegionIdResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i205 in range(_size201):
                        _elem206 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _elem206.read(iprot)
                        self.dataRegionIdList.append(_elem206)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataRegionIdList is not None:
            ...
            for iter207 in self.dataRegionIdList:
                iter207.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetTimeSlotListResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i212 in range(_size208):
                        _elem213 = iotdb.thrift.common.ttypes.TTimePartitionSlot()
                        _elem213.read(iprot)
                        self.timeSlotList.append(_elem213)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.timeSlotList is not None:
            ...
            for iter214 in self.timeSlotList:
                iter214.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetRegionGroupsByTimeReq(object):
    """
    Attributes:
     - database
     - startTime
    ...
    def __init__(self, database=None, startTime=None, endTime=None,):
        self.database = database
        self.startTime = startTime
        self.endTime = endTime
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetRegionGroupsByTimeReq')
        if self.database is not None:
            oprot.writeFieldBegin('database', TType.STRING, 1)
            oprot.writeString(self.database.encode('utf-8') if sys.version_info[0] == 2 else self.database)
            oprot.writeFieldEnd()
...
class TGetRegionGroupsByTimeResp(object):
    """
    Attributes:
     - status
     - regionReplicaSets
    ...
    def __init__(self, status=None, regionReplicaSets=None,):
        self.status = status
        self.regionReplicaSets = regionReplicaSets
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    self.regionReplicaSets = set()
                    (_etype218, _size215) = iprot.readSetBegin()
                    for _i219 in range(_size215):
                        _elem220 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _elem220.read(iprot)
                        self.regionReplicaSets.add(_elem220)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetRegionGroupsByTimeResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
        if self.regionReplicaSets is not None:
            oprot.writeFieldBegin('regionReplicaSets', TType.SET, 2)
            oprot.writeSetBegin(TType.STRUCT, len(self.regionReplicaSets))
            for iter221 in self.regionReplicaSets:
                iter221.write(oprot)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetSeriesSlotListResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i226 in range(_size222):
                        _elem227 = iotdb.thrift.common.ttypes.TSeriesPartitionSlot()
                        _elem227.read(iprot)
                        self.seriesSlotList.append(_elem227)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.seriesSlotList is not None:
            ...
            for iter228 in self.seriesSlotList:
                iter228.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i233 in range(_size229):
                        ...
                        self.regionIds.append(_elem234)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
...
class TExtendRegionReq(object):
    ...
    def write(self, oprot):
        ...
        if self.regionId is not None:
            oprot.writeFieldBegin('regionId', TType.LIST, 1)
            oprot.writeListBegin(TType.I32, len(self.regionId))
            for iter242 in self.regionId:
...
class TAuthorizerReq(object):
    ...
    def __init__(self, authorType=None, userName=None, roleName=None, password=None, newPassword=None, permissions=None, grantOpt=None, nodeNameList=None, executedByUserID=None, newUsername=None,):
        ...
        self.executedByUserID = executedByUserID
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I64:
                    self.executedByUserID = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.STRING:
                    self.newUsername = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.permissions is not None:
            ...
            for iter256 in self.permissions:
        ...
        if self.nodeNameList is not None:
            ...
            oprot.writeFieldEnd()
        if self.executedByUserID is not None:
            oprot.writeFieldBegin('executedByUserID', TType.I64, 9)
            oprot.writeI64(self.executedByUserID)
            oprot.writeFieldEnd()
        if self.newUsername is not None:
            oprot.writeFieldBegin('newUsername', TType.STRING, 10)
            oprot.writeString(self.newUsername.encode('utf-8') if sys.version_info[0] == 2 else self.newUsername)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.executedByUserID is None:
            raise TProtocolException(message='Required field executedByUserID is unset!')
        if self.newUsername is None:
            raise TProtocolException(message='Required field newUsername is unset!')
        return
...
class TAuthorizerRelationalReq(object):
    ...
    def __init__(self, authorType=None, userName=None, roleName=None, password=None, database=None, table=None, permissions=None, grantOpt=None, executedByUserID=None, newUsername=None,):
        self.authorType = authorType
        self.userName = userName
        self.roleName = roleName
        self.password = password
    ...
    def write(self, oprot):
        ...
        if self.permissions is not None:
            ...
            oprot.writeSetBegin(TType.I32, len(self.permissions))
            for iter263 in self.permissions:
...
class TAuthorizerResp(object):
    ...
    def __init__(self, status=None, tag=None, memberInfo=None, permissionInfo=None, usersInfo=None,):
        self.status = status
        self.tag = tag
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i268 in range(_size264):
                        ...
                        self.memberInfo.append(_elem269)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i274 in range(_size270):
                        _elem275 = TListUserInfo()
                        _elem275.read(iprot)
                        self.usersInfo.append(_elem275)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.memberInfo is not None:
            ...
            for iter276 in self.memberInfo:
        ...
        if self.permissionInfo is not None:
            ...
            oprot.writeFieldEnd()
        if self.usersInfo is not None:
            oprot.writeFieldBegin('usersInfo', TType.LIST, 5)
            oprot.writeListBegin(TType.STRUCT, len(self.usersInfo))
            for iter277 in self.usersInfo:
                iter277.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TListUserInfo(object):
    ...
    def __init__(self, userId=None, username=None, maxSessionPerUser=None, minSessionPerUser=None,):
        self.userId = userId
        self.username = username
        self.maxSessionPerUser = maxSessionPerUser
        self.minSessionPerUser = minSessionPerUser
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.maxSessionPerUser = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                    self.minSessionPerUser = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TListUserInfo')
        ...
        if self.username is not None:
            ...
            oprot.writeString(self.username.encode('utf-8') if sys.version_info[0] == 2 else self.username)
            oprot.writeFieldEnd()
        if self.maxSessionPerUser is not None:
            oprot.writeFieldBegin('maxSessionPerUser', TType.I32, 3)
            oprot.writeI32(self.maxSessionPerUser)
            oprot.writeFieldEnd()
        if self.minSessionPerUser is not None:
            oprot.writeFieldBegin('minSessionPerUser', TType.I32, 4)
            oprot.writeI32(self.minSessionPerUser)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.username is None:
            raise TProtocolException(message='Required field username is unset!')
        if self.maxSessionPerUser is None:
            raise TProtocolException(message='Required field maxSessionPerUser is unset!')
        if self.minSessionPerUser is None:
            raise TProtocolException(message='Required field minSessionPerUser is unset!')
        return
...
class TUserResp(object):
    ...
    def __init__(self, permissionInfo=None, password=None, roleSet=None, isOpenIdUser=None, userId=None,):
        self.permissionInfo = permissionInfo
        self.password = password
...
class TRoleResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i289 in range(_size285):
                        _elem290 = TPathPrivilege()
                        _elem290.read(iprot)
                        self.privilegeList.append(_elem290)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.SET:
                    self.sysPriSet = set()
                    (_etype294, _size291) = iprot.readSetBegin()
                    for _i295 in range(_size291):
                        _elem296 = iprot.readI32()
                        self.sysPriSet.add(_elem296)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.SET:
                    ...
                    for _i301 in range(_size297):
                        ...
                        self.sysPriSetGrantOpt.add(_elem302)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i307 in range(_size303):
                        ...
                        _val309 = TDBPrivilege()
                        _val309.read(iprot)
                        self.dbPrivilegeMap[_key308] = _val309
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.SET:
                    ...
                    (_etype313, _size310) = iprot.readSetBegin()
                    for _i314 in range(_size310):
                        _elem315 = iprot.readI32()
                        self.anyScopeSet.add(_elem315)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.SET:
                    ...
                    for _i320 in range(_size316):
                        ...
                        self.anyScopeGrantSet.add(_elem321)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.privilegeList is not None:
            ...
            for iter322 in self.privilegeList:
                iter322.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.sysPriSetGrantOpt is not None:
            ...
            for iter324 in self.sysPriSetGrantOpt:
        ...
        if self.dbPrivilegeMap is not None:
            ...
            for kiter325, viter326 in self.dbPrivilegeMap.items():
        ...
        if self.anyScopeSet is not None:
            ...
            for iter327 in self.anyScopeSet:
        ...
        if self.anyScopeGrantSet is not None:
            ...
            for iter328 in self.anyScopeGrantSet:
...
class TPathPrivilege(object):
    ...
    def write(self, oprot):
        ...
        if self.priGrantOpt is not None:
            ...
            for iter342 in self.priGrantOpt:
...
class TTablePrivilege(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i353 in range(_size349):
                        _elem354 = iprot.readI32()
                        self.grantOption.add(_elem354)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.privileges is not None:
            ...
            for iter355 in self.privileges:
                oprot.writeI32(iter355)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.grantOption is not None:
            ...
            for iter356 in self.grantOption:
...
class TDBPrivilege(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i373 in range(_size369):
                        _key374 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val375 = TTablePrivilege()
                        _val375.read(iprot)
                        self.tablePrivilegeMap[_key374] = _val375
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.privileges is not None:
            oprot.writeFieldBegin('privileges', TType.SET, 2)
            oprot.writeSetBegin(TType.I32, len(self.privileges))
            for iter376 in self.privileges:
...
class TPermissionInfoResp(object):
    ...
    def write(self, oprot):
        ...
        if self.roleInfo is not None:
            ...
            for kiter394, viter395 in self.roleInfo.items():
...
class TLoginReq(object):
    ...
    def __init__(self, userrname=None, password=None, useEncryptedPassword=None,):
        self.userrname = userrname
        self.password = password
        self.useEncryptedPassword = useEncryptedPassword
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.useEncryptedPassword = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.password is not None:
            ...
            oprot.writeString(self.password.encode('utf-8') if sys.version_info[0] == 2 else self.password)
            oprot.writeFieldEnd()
        if self.useEncryptedPassword is not None:
            oprot.writeFieldBegin('useEncryptedPassword', TType.BOOL, 3)
            oprot.writeBool(self.useEncryptedPassword)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAddConsensusGroupReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i400 in range(_size396):
                        _elem401 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem401.read(iprot)
                        self.configNodeList.append(_elem401)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter402 in self.configNodeList:
                iter402.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetUDFTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i407 in range(_size403):
                        ...
                        self.allUDFInformation.append(_elem408)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allUDFInformation is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.allUDFInformation))
            for iter409 in self.allUDFInformation:
...
class TCreateTriggerReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i414 in range(_size410):
                        ...
                        self.attributes[_key415] = _val416
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter417, viter418 in self.attributes.items():
                oprot.writeString(kiter417.encode('utf-8') if sys.version_info[0] == 2 else kiter417)
                oprot.writeString(viter418.encode('utf-8') if sys.version_info[0] == 2 else viter418)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TGetTriggerTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i423 in range(_size419):
                        ...
                        self.allTriggerInformation.append(_elem424)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allTriggerInformation is not None:
            oprot.writeFieldBegin('allTriggerInformation', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.allTriggerInformation))
            for iter425 in self.allTriggerInformation:
                oprot.writeBinary(iter425)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetJarInListReq(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i430 in range(_size426):
                        _elem431 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.jarNameList.append(_elem431)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.jarNameList is not None:
            ...
            for iter432 in self.jarNameList:
...
class TGetDataNodeLocationsResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i444 in range(_size440):
                        _elem445 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _elem445.read(iprot)
                        self.dataNodeLocationList.append(_elem445)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodeLocationList is not None:
            ...
            for iter446 in self.dataNodeLocationList:
                iter446.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowClusterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i451 in range(_size447):
                        _elem452 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem452.read(iprot)
                        self.configNodeList.append(_elem452)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i457 in range(_size453):
                        _elem458 = iotdb.thrift.common.ttypes.TDataNodeLocation()
                        _elem458.read(iprot)
                        self.dataNodeList.append(_elem458)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i463 in range(_size459):
                        _elem464 = iotdb.thrift.common.ttypes.TAINodeLocation()
                        _elem464.read(iprot)
                        self.aiNodeList.append(_elem464)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.MAP:
                    ...
                    for _i469 in range(_size465):
                        ...
                        self.nodeStatus[_key470] = _val471
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.MAP:
                    ...
                    for _i476 in range(_size472):
                        ...
                        _val478 = TNodeVersionInfo()
                        _val478.read(iprot)
                        self.nodeVersionInfo[_key477] = _val478
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter479 in self.configNodeList:
                iter479.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dataNodeList is not None:
            ...
            for iter480 in self.dataNodeList:
                iter480.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aiNodeList is not None:
            ...
            for iter481 in self.aiNodeList:
                iter481.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.nodeStatus is not None:
            ...
            for kiter482, viter483 in self.nodeStatus.items():
        ...
        if self.nodeVersionInfo is not None:
            ...
            for kiter484, viter485 in self.nodeVersionInfo.items():
                oprot.writeI32(kiter484)
...
class TGetAINodeLocationResp(object):
    """
    Attributes:
     - status
     - aiNodeLocation
    ...
    def __init__(self, status=None, aiNodeLocation=None,):
        self.status = status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetAINodeLocationResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
        if self.aiNodeLocation is not None:
            oprot.writeFieldBegin('aiNodeLocation', TType.STRUCT, 2)
...
class TShowDataNodes4InformationSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i490 in range(_size486):
                        _elem491 = TDataNodeInfo4InformationSchema()
                        _elem491.read(iprot)
                        self.dataNodesInfoList.append(_elem491)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodesInfoList is not None:
            ...
            for iter492 in self.dataNodesInfoList:
                iter492.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowDataNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i497 in range(_size493):
                        _elem498 = TDataNodeInfo()
                        _elem498.read(iprot)
                        self.dataNodesInfoList.append(_elem498)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.dataNodesInfoList is not None:
            oprot.writeFieldBegin('dataNodesInfoList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.dataNodesInfoList))
            for iter499 in self.dataNodesInfoList:
                iter499.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowAINodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i504 in range(_size500):
                        _elem505 = TAINodeInfo()
                        _elem505.read(iprot)
                        self.aiNodesInfoList.append(_elem505)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodesInfoList is not None:
            ...
            for iter506 in self.aiNodesInfoList:
                iter506.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowConfigNodesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i511 in range(_size507):
                        _elem512 = TConfigNodeInfo()
                        _elem512.read(iprot)
                        self.configNodesInfoList.append(_elem512)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodesInfoList is not None:
            ...
            for iter513 in self.configNodesInfoList:
                iter513.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowConfigNodes4InformationSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i518 in range(_size514):
                        _elem519 = TConfigNodeInfo4InformationSchema()
                        _elem519.read(iprot)
                        self.configNodesInfoList.append(_elem519)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodesInfoList is not None:
            oprot.writeFieldBegin('configNodesInfoList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodesInfoList))
            for iter520 in self.configNodesInfoList:
                iter520.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetDatabaseReq(object):
    ...
    def __init__(self, databasePathPattern=None, scopePatternTree=None, isTableModel=None, canSeeAuditDB=None,):
        self.databasePathPattern = databasePathPattern
        self.scopePatternTree = scopePatternTree
        self.isTableModel = isTableModel
        self.canSeeAuditDB = canSeeAuditDB
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i525 in range(_size521):
                        ...
                        self.databasePathPattern.append(_elem526)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.BOOL:
                    self.canSeeAuditDB = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.databasePathPattern is not None:
            ...
            for iter527 in self.databasePathPattern:
        ...
        if self.isTableModel is not None:
            ...
            oprot.writeBool(self.isTableModel)
            oprot.writeFieldEnd()
        if self.canSeeAuditDB is not None:
            oprot.writeFieldBegin('canSeeAuditDB', TType.BOOL, 4)
            oprot.writeBool(self.canSeeAuditDB)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowDatabaseResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i532 in range(_size528):
                        ...
                        _val534 = TDatabaseInfo()
                        _val534.read(iprot)
                        self.databaseInfoMap[_key533] = _val534
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseInfoMap is not None:
            ...
            for kiter535, viter536 in self.databaseInfoMap.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i541 in range(_size537):
                        _elem542 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.databases.append(_elem542)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class TRegionInfo(object):
    ...
    def __init__(self, consensusGroupId=None, database=None, dataNodeId=None, clientRpcIp=None, clientRpcPort=None, seriesSlots=None, timeSlots=None, status=None, roleType=None, createTime=None, internalAddress=None, tsFileSize=None, rawDataSize=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I64:
                    self.rawDataSize = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.tsFileSize is not None:
            ...
            oprot.writeFieldEnd()
        if self.rawDataSize is not None:
            oprot.writeFieldBegin('rawDataSize', TType.I64, 13)
            oprot.writeI64(self.rawDataSize)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowRegionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i548 in range(_size544):
                        _elem549 = TRegionInfo()
                        _elem549.read(iprot)
                        self.regionInfoList.append(_elem549)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionInfoList is not None:
            ...
            for iter550 in self.regionInfoList:
                iter550.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TRegionRouteMapResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i555 in range(_size551):
                        _key556 = iotdb.thrift.common.ttypes.TConsensusGroupId()
                        _key556.read(iprot)
                        _val557 = iotdb.thrift.common.ttypes.TRegionReplicaSet()
                        _val557.read(iprot)
                        self.regionRouteMap[_key556] = _val557
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.regionRouteMap is not None:
            ...
            for kiter558, viter559 in self.regionRouteMap.items():
...
class TGetAllTemplatesResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i564 in range(_size560):
                        _elem565 = iprot.readBinary()
                        self.templateList.append(_elem565)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.templateList is not None:
            ...
            for iter566 in self.templateList:
                oprot.writeBinary(iter566)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetPipePluginTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i578 in range(_size574):
                        ...
                        self.allPipePluginMeta.append(_elem579)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipePluginMeta is not None:
            ...
            for iter580 in self.allPipePluginMeta:
                oprot.writeBinary(iter580)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetAllPipeInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i585 in range(_size581):
                        _elem586 = iprot.readBinary()
                        self.allPipeInfo.append(_elem586)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allPipeInfo is not None:
            ...
            for iter587 in self.allPipeInfo:
                oprot.writeBinary(iter587)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreatePipeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i592 in range(_size588):
                        _key593 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val594 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.extractorAttributes[_key593] = _val594
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i599 in range(_size595):
                        _key600 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val601 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.processorAttributes[_key600] = _val601
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i606 in range(_size602):
                        ...
                        self.connectorAttributes[_key607] = _val608
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.extractorAttributes is not None:
            ...
            for kiter609, viter610 in self.extractorAttributes.items():
        ...
        if self.processorAttributes is not None:
            ...
            for kiter611, viter612 in self.processorAttributes.items():
        ...
        if self.connectorAttributes is not None:
            ...
            for kiter613, viter614 in self.connectorAttributes.items():
                oprot.writeString(kiter613.encode('utf-8') if sys.version_info[0] == 2 else kiter613)
                oprot.writeString(viter614.encode('utf-8') if sys.version_info[0] == 2 else viter614)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.ifNotExistsCondition is not None:
...
class TAlterPipeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i619 in range(_size615):
                        _key620 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val621 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.processorAttributes[_key620] = _val621
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i626 in range(_size622):
                        _key627 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val628 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.connectorAttributes[_key627] = _val628
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i633 in range(_size629):
                        _key634 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val635 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.extractorAttributes[_key634] = _val635
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.processorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.processorAttributes))
            for kiter636, viter637 in self.processorAttributes.items():
        ...
        if self.connectorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.connectorAttributes))
            for kiter638, viter639 in self.connectorAttributes.items():
        ...
        if self.extractorAttributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.extractorAttributes))
            for kiter640, viter641 in self.extractorAttributes.items():
                oprot.writeString(kiter640.encode('utf-8') if sys.version_info[0] == 2 else kiter640)
                oprot.writeString(viter641.encode('utf-8') if sys.version_info[0] == 2 else viter641)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TPipeSinkInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i646 in range(_size642):
                        _key647 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val648 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key647] = _val648
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter649, viter650 in self.attributes.items():
                oprot.writeString(kiter649.encode('utf-8') if sys.version_info[0] == 2 else kiter649)
                oprot.writeString(viter650.encode('utf-8') if sys.version_info[0] == 2 else viter650)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TShowPipeReq(object):
    ...
    def __init__(self, pipeName=None, whereClause=None, isTableModel=None, userName=None,):
        self.pipeName = pipeName
...
class TShowPipeResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i655 in range(_size651):
                        _elem656 = TShowPipeInfo()
                        _elem656.read(iprot)
                        self.pipeInfoList.append(_elem656)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.pipeInfoList is not None:
            ...
            for iter657 in self.pipeInfoList:
                iter657.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TAlterEncodingCompressorReq(object):
    """
    Attributes:
     - queryId
     - pathPatternTree
    ...
    def __init__(self, queryId=None, pathPatternTree=None, encoding=None, compressor=None, ifExists=None, mayAlterAudit=None, isGeneratedByPipe=None,):
        self.queryId = queryId
        self.pathPatternTree = pathPatternTree
        self.encoding = encoding
        self.compressor = compressor
        self.ifExists = ifExists
        self.mayAlterAudit = mayAlterAudit
        self.isGeneratedByPipe = isGeneratedByPipe
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BYTE:
                    self.encoding = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BYTE:
                    self.compressor = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.BOOL:
                    self.mayAlterAudit = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TAlterEncodingCompressorReq')
        if self.queryId is not None:
            oprot.writeFieldBegin('queryId', TType.STRING, 1)
            oprot.writeString(self.queryId.encode('utf-8') if sys.version_info[0] == 2 else self.queryId)
            oprot.writeFieldEnd()
        ...
        if self.encoding is not None:
            oprot.writeFieldBegin('encoding', TType.BYTE, 3)
            oprot.writeByte(self.encoding)
            oprot.writeFieldEnd()
        if self.compressor is not None:
            oprot.writeFieldBegin('compressor', TType.BYTE, 4)
            oprot.writeByte(self.compressor)
            oprot.writeFieldEnd()
        if self.ifExists is not None:
            oprot.writeFieldBegin('ifExists', TType.BOOL, 5)
            oprot.writeBool(self.ifExists)
            oprot.writeFieldEnd()
        if self.mayAlterAudit is not None:
            oprot.writeFieldBegin('mayAlterAudit', TType.BOOL, 6)
            oprot.writeBool(self.mayAlterAudit)
            oprot.writeFieldEnd()
        if self.isGeneratedByPipe is not None:
            oprot.writeFieldBegin('isGeneratedByPipe', TType.BOOL, 7)
            oprot.writeBool(self.isGeneratedByPipe)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.ifExists is None:
            raise TProtocolException(message='Required field ifExists is unset!')
        if self.mayAlterAudit is None:
            raise TProtocolException(message='Required field mayAlterAudit is unset!')
        return
...
class TDeleteTimeSeriesReq(object):
    ...
    def __init__(self, queryId=None, pathPatternTree=None, isGeneratedByPipe=None, mayDeleteAudit=None,):
        self.queryId = queryId
        self.pathPatternTree = pathPatternTree
        self.isGeneratedByPipe = isGeneratedByPipe
        self.mayDeleteAudit = mayDeleteAudit
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.mayDeleteAudit = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.isGeneratedByPipe is not None:
            ...
            oprot.writeBool(self.isGeneratedByPipe)
            oprot.writeFieldEnd()
        if self.mayDeleteAudit is not None:
            oprot.writeFieldBegin('mayDeleteAudit', TType.BOOL, 4)
            oprot.writeBool(self.mayDeleteAudit)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAlterTimeSeriesReq(object):
    """
    Attributes:
     - queryId
     - measurementPath
    ...
    def __init__(self, queryId=None, measurementPath=None, operationType=None, updateInfo=None,):
        self.queryId = queryId
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.measurementPath = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BYTE:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TAlterTimeSeriesReq')
        if self.queryId is not None:
            oprot.writeFieldBegin('queryId', TType.STRING, 1)
            oprot.writeString(self.queryId.encode('utf-8') if sys.version_info[0] == 2 else self.queryId)
            oprot.writeFieldEnd()
        if self.measurementPath is not None:
            oprot.writeFieldBegin('measurementPath', TType.STRING, 2)
            oprot.writeBinary(self.measurementPath)
            oprot.writeFieldEnd()
        if self.operationType is not None:
            oprot.writeFieldBegin('operationType', TType.BYTE, 3)
            oprot.writeByte(self.operationType)
            oprot.writeFieldEnd()
        if self.updateInfo is not None:
            oprot.writeFieldBegin('updateInfo', TType.STRING, 4)
    ...
    def validate(self):
        if self.queryId is None:
            raise TProtocolException(message='Required field queryId is unset!')
        if self.measurementPath is None:
            raise TProtocolException(message='Required field measurementPath is unset!')
...
class TCreateTopicReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i662 in range(_size658):
                        ...
                        self.topicAttributes[_key663] = _val664
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.topicAttributes is not None:
            ...
            for kiter665, viter666 in self.topicAttributes.items():
                oprot.writeString(kiter665.encode('utf-8') if sys.version_info[0] == 2 else kiter665)
                oprot.writeString(viter666.encode('utf-8') if sys.version_info[0] == 2 else viter666)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.ifNotExistsCondition is not None:
...
class TShowTopicResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i671 in range(_size667):
                        _elem672 = TShowTopicInfo()
                        _elem672.read(iprot)
                        self.topicInfoList.append(_elem672)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicInfoList is not None:
            ...
            for iter673 in self.topicInfoList:
                iter673.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TAlterTopicReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i678 in range(_size674):
                        _key679 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val680 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicAttributes[_key679] = _val680
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.SET:
                    ...
                    for _i685 in range(_size681):
                        ...
                        self.subscribedConsumerGroupIds.add(_elem686)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.topicAttributes is not None:
            oprot.writeFieldBegin('topicAttributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.topicAttributes))
            for kiter687, viter688 in self.topicAttributes.items():
        ...
        if self.subscribedConsumerGroupIds is not None:
            ...
            for iter689 in self.subscribedConsumerGroupIds:
...
class TGetAllTopicInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i694 in range(_size690):
                        _elem695 = iprot.readBinary()
                        self.allTopicInfo.append(_elem695)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allTopicInfo is not None:
            ...
            for iter696 in self.allTopicInfo:
                oprot.writeBinary(iter696)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreateConsumerReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i701 in range(_size697):
                        ...
                        self.consumerAttributes[_key702] = _val703
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.consumerAttributes is not None:
            ...
            for kiter704, viter705 in self.consumerAttributes.items():
                oprot.writeString(kiter704.encode('utf-8') if sys.version_info[0] == 2 else kiter704)
                oprot.writeString(viter705.encode('utf-8') if sys.version_info[0] == 2 else viter705)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TSubscribeReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i710 in range(_size706):
                        _elem711 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.topicNames.add(_elem711)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.topicNames is not None:
            ...
            for iter712 in self.topicNames:
...
class TUnsubscribeReq(object):
    ...
    def write(self, oprot):
        ...
        if self.topicNames is not None:
            oprot.writeFieldBegin('topicNames', TType.SET, 3)
            oprot.writeSetBegin(TType.STRING, len(self.topicNames))
            for iter719 in self.topicNames:
...
class TShowSubscriptionResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i724 in range(_size720):
                        _elem725 = TShowSubscriptionInfo()
                        _elem725.read(iprot)
                        self.subscriptionInfoList.append(_elem725)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.subscriptionInfoList is not None:
            ...
            for iter726 in self.subscriptionInfoList:
                iter726.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowSubscriptionInfo(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    (_etype730, _size727) = iprot.readSetBegin()
    ...
    def write(self, oprot):
        ...
        if self.consumerIds is not None:
            ...
            for iter733 in self.consumerIds:
...
class TGetAllSubscriptionInfoResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i738 in range(_size734):
                        _elem739 = iprot.readBinary()
                        self.allSubscriptionInfo.append(_elem739)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.allSubscriptionInfo is not None:
            ...
            for iter740 in self.allSubscriptionInfo:
                oprot.writeBinary(iter740)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCreateExternalServiceReq(object):
    """
    Attributes:
     - dataNodeId
     - serviceName
    ...
    def __init__(self, dataNodeId=None, serviceName=None, className=None,):
        self.dataNodeId = dataNodeId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TCreateExternalServiceReq')
        if self.dataNodeId is not None:
            oprot.writeFieldBegin('dataNodeId', TType.I32, 1)
            oprot.writeI32(self.dataNodeId)
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i752 in range(_size748):
                        _elem753 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem753)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TSpaceQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i759 in range(_size755):
                        _key760 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val761 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val761.read(iprot)
                        self.spaceQuota[_key760] = _val761
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i766 in range(_size762):
                        _key767 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val768 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val768.read(iprot)
                        self.spaceQuotaUsage[_key767] = _val768
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            for kiter769, viter770 in self.spaceQuota.items():
                oprot.writeString(kiter769.encode('utf-8') if sys.version_info[0] == 2 else kiter769)
                viter770.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.spaceQuotaUsage is not None:
            ...
            for kiter771, viter772 in self.spaceQuotaUsage.items():
...
class TThrottleQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i777 in range(_size773):
                        _key778 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val779 = iotdb.thrift.common.ttypes.TThrottleQuota()
                        _val779.read(iprot)
                        self.throttleQuota[_key778] = _val779
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.throttleQuota is not None:
            ...
            for kiter780, viter781 in self.throttleQuota.items():
...
class TAINodeConfigurationResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i786 in range(_size782):
                        _key787 = iprot.readI32()
                        _val788 = iotdb.thrift.common.ttypes.TAINodeConfiguration()
                        _val788.read(iprot)
                        self.aiNodeConfigurationMap[_key787] = _val788
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodeConfigurationMap is not None:
            ...
            for kiter789, viter790 in self.aiNodeConfigurationMap.items():
                oprot.writeI32(kiter789)
                viter790.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAINodeRegisterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i795 in range(_size791):
                        _elem796 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem796.read(iprot)
                        self.configNodeList.append(_elem796)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter797 in self.configNodeList:
                iter797.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aiNodeId is not None:
...
class TAINodeRestartResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i802 in range(_size798):
                        _elem803 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem803.read(iprot)
                        self.configNodeList.append(_elem803)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter804 in self.configNodeList:
                iter804.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i809 in range(_size805):
                        _elem810 = TTableInfo()
                        _elem810.read(iprot)
                        self.tableInfoList.append(_elem810)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableInfoList is not None:
            ...
            for iter811 in self.tableInfoList:
                iter811.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTable4InformationSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i816 in range(_size812):
                        _key817 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val818 = []
                        (_etype822, _size819) = iprot.readListBegin()
                        for _i823 in range(_size819):
                            _elem824 = TTableInfo()
                            _elem824.read(iprot)
                            _val818.append(_elem824)
                        iprot.readListEnd()
                        self.databaseTableInfoMap[_key817] = _val818
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseTableInfoMap is not None:
            ...
            for kiter825, viter826 in self.databaseTableInfoMap.items():
                oprot.writeString(kiter825.encode('utf-8') if sys.version_info[0] == 2 else kiter825)
                oprot.writeListBegin(TType.STRUCT, len(viter826))
                for iter827 in viter826:
                    iter827.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class TDescTableResp(object):
    ...
    def __init__(self, status=None, tableInfo=None, preDeletedColumns=None, preAlteredColumns=None,):
        self.status = status
        self.tableInfo = tableInfo
        self.preDeletedColumns = preDeletedColumns
        self.preAlteredColumns = preAlteredColumns
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    (_etype831, _size828) = iprot.readSetBegin()
                    for _i832 in range(_size828):
                        _elem833 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.preDeletedColumns.add(_elem833)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    self.preAlteredColumns = {}
                    (_ktype835, _vtype836, _size834) = iprot.readMapBegin()
                    for _i838 in range(_size834):
                        _key839 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val840 = iprot.readByte()
                        self.preAlteredColumns[_key839] = _val840
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            for iter841 in self.preDeletedColumns:
                oprot.writeString(iter841.encode('utf-8') if sys.version_info[0] == 2 else iter841)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.preAlteredColumns is not None:
            oprot.writeFieldBegin('preAlteredColumns', TType.MAP, 4)
            oprot.writeMapBegin(TType.STRING, TType.BYTE, len(self.preAlteredColumns))
            for kiter842, viter843 in self.preAlteredColumns.items():
                oprot.writeString(kiter842.encode('utf-8') if sys.version_info[0] == 2 else kiter842)
                oprot.writeByte(viter843)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TDescTable4InformationSchemaResp(object):
                ...
                if ftype == TType.MAP:
                    ...
                    for _i848 in range(_size844):
                        ...
                        for _i855 in range(_size851):
                            _key856 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val857 = TTableColumnInfo()
                            _val857.read(iprot)
                            _val850[_key856] = _val857
                        iprot.readMapEnd()
                        self.tableColumnInfoMap[_key849] = _val850
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableColumnInfoMap is not None:
            ...
            for kiter858, viter859 in self.tableColumnInfoMap.items():
                oprot.writeString(kiter858.encode('utf-8') if sys.version_info[0] == 2 else kiter858)
                oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(viter859))
                for kiter860, viter861 in viter859.items():
                    oprot.writeString(kiter860.encode('utf-8') if sys.version_info[0] == 2 else kiter860)
                    viter861.write(oprot)
                oprot.writeMapEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TTableColumnInfo(object):
    ...
    def __init__(self, tableInfo=None, preDeletedColumns=None, preAlteredColumns=None,):
        self.tableInfo = tableInfo
        self.preDeletedColumns = preDeletedColumns
        self.preAlteredColumns = preAlteredColumns
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i866 in range(_size862):
                        _elem867 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.preDeletedColumns.add(_elem867)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i872 in range(_size868):
                        _key873 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val874 = iprot.readByte()
                        self.preAlteredColumns[_key873] = _val874
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            oprot.writeSetBegin(TType.STRING, len(self.preDeletedColumns))
            for iter875 in self.preDeletedColumns:
                oprot.writeString(iter875.encode('utf-8') if sys.version_info[0] == 2 else iter875)
            oprot.writeSetEnd()
            oprot.writeFieldEnd()
        if self.preAlteredColumns is not None:
            oprot.writeFieldBegin('preAlteredColumns', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.BYTE, len(self.preAlteredColumns))
            for kiter876, viter877 in self.preAlteredColumns.items():
                oprot.writeString(kiter876.encode('utf-8') if sys.version_info[0] == 2 else kiter876)
                oprot.writeByte(viter877)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(TAuditConfig)
TAuditConfig.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'enableAuditLog', None, None, ),  # 1
    (2, TType.STRING, 'auditableOperationType', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'auditableOperationLevel', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'auditableOperationResult', 'UTF8', None, ),  # 4
)
...
TGlobalConfig.thrift_spec = (
    ...
    (8, TType.BOOL, 'enableGrantOption', None, None, ),  # 8
    (9, TType.STRING, 'timestampPrecision', 'UTF8', None, ),  # 9
    (10, TType.STRING, 'schemaEngineMode', 'UTF8', None, ),  # 10
    (11, TType.I32, 'tagAttributeTotalSize', None, None, ),  # 11
    (12, TType.BOOL, 'isEnterprise', None, None, ),  # 12
    (13, TType.I64, 'timePartitionOrigin', None, None, ),  # 13
    (14, TType.BOOL, 'restrictObjectLimit', None, None, ),  # 14
)
...
TRatisConfig.thrift_spec = (
    ...
    (35, TType.I32, 'ratisTransferLeaderTimeoutMs', None, None, ),  # 35
    (36, TType.I32, 'schemaReconfigurationMaxRetryAttempts', None, None, ),  # 36
    (37, TType.I32, 'dataReconfigurationMaxRetryAttempts', None, None, ),  # 37
)
...
TRuntimeConfiguration.thrift_spec = (
    ...
    (8, TType.STRUCT, 'auditConfig', [TAuditConfig, None], None, ),  # 8
    (9, TType.STRING, 'superUserName', 'UTF8', None, ),  # 9
    (10, TType.BOOL, 'enableSeparationOfAdminPowers', None, None, ),  # 10
    (11, TType.LIST, 'allUserDefinedServiceInfo', (TType.STRUCT, [iotdb.thrift.common.ttypes.TExternalServiceEntry, None], False), None, ),  # 11
)
...
TSchemaNodeManagementReq.thrift_spec = (
    ...
    (4, TType.BOOL, 'needAuditDB', None, None, ),  # 4
)
...
all_structs.append(TGetRegionGroupsByTimeReq)
TGetRegionGroupsByTimeReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'database', 'UTF8', None, ),  # 1
    (2, TType.I64, 'startTime', None, None, ),  # 2
    (3, TType.I64, 'endTime', None, None, ),  # 3
)
all_structs.append(TGetRegionGroupsByTimeResp)
TGetRegionGroupsByTimeResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.SET, 'regionReplicaSets', (TType.STRUCT, [iotdb.thrift.common.ttypes.TRegionReplicaSet, None], False), None, ),  # 2
)
...
TExtendRegionReq.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'regionId', (TType.I32, None, False), None, ),  # 1
    (2, TType.I32, 'dataNodeId', None, None, ),  # 2
    (3, TType.I32, 'model', None, None, ),  # 3
)
...
TAuthorizerReq.thrift_spec = (
    ...
    (9, TType.I64, 'executedByUserID', None, None, ),  # 9
    (10, TType.STRING, 'newUsername', 'UTF8', None, ),  # 10
)
...
TAuthorizerResp.thrift_spec = (
    ...
    (5, TType.LIST, 'usersInfo', (TType.STRUCT, [TListUserInfo, None], False), None, ),  # 5
)
all_structs.append(TListUserInfo)
TListUserInfo.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'userId', None, None, ),  # 1
    (2, TType.STRING, 'username', 'UTF8', None, ),  # 2
    (3, TType.I32, 'maxSessionPerUser', None, None, ),  # 3
    (4, TType.I32, 'minSessionPerUser', None, None, ),  # 4
)
...
TLoginReq.thrift_spec = (
    ...
    (2, TType.STRING, 'password', 'UTF8', None, ),  # 2
    (3, TType.BOOL, 'useEncryptedPassword', None, None, ),  # 3
)
...
all_structs.append(TGetAINodeLocationResp)
TGetAINodeLocationResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [iotdb.thrift.common.ttypes.TSStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'aiNodeLocation', [iotdb.thrift.common.ttypes.TAINodeLocation, None], None, ),  # 2
)
...
TGetDatabaseReq.thrift_spec = (
    ...
    (3, TType.BOOL, 'isTableModel', None, None, ),  # 3
    (4, TType.BOOL, 'canSeeAuditDB', None, None, ),  # 4
)
...
TRegionInfo.thrift_spec = (
    ...
    (13, TType.I64, 'rawDataSize', None, None, ),  # 13
)
...
all_structs.append(TAlterEncodingCompressorReq)
TAlterEncodingCompressorReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'queryId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'pathPatternTree', 'BINARY', None, ),  # 2
    (3, TType.BYTE, 'encoding', None, None, ),  # 3
    (4, TType.BYTE, 'compressor', None, None, ),  # 4
    (5, TType.BOOL, 'ifExists', None, None, ),  # 5
    (6, TType.BOOL, 'mayAlterAudit', None, None, ),  # 6
    (7, TType.BOOL, 'isGeneratedByPipe', None, None, ),  # 7
)
...
TDeleteTimeSeriesReq.thrift_spec = (
    ...
    (4, TType.BOOL, 'mayDeleteAudit', None, None, ),  # 4
)
all_structs.append(TAlterTimeSeriesReq)
TAlterTimeSeriesReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'queryId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'measurementPath', 'BINARY', None, ),  # 2
    (3, TType.BYTE, 'operationType', None, None, ),  # 3
    (4, TType.STRING, 'updateInfo', 'BINARY', None, ),  # 4
)
...
all_structs.append(TCreateExternalServiceReq)
TCreateExternalServiceReq.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'dataNodeId', None, None, ),  # 1
...
TDescTableResp.thrift_spec = (
    ...
    (4, TType.MAP, 'preAlteredColumns', (TType.STRING, 'UTF8', TType.BYTE, None, False), None, ),  # 4
)
...
TTableColumnInfo.thrift_spec = (
    ...
    (3, TType.MAP, 'preAlteredColumns', (TType.STRING, 'UTF8', TType.BYTE, None, False), None, ),  # 3
)
