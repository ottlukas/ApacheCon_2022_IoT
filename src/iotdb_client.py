...
class IoTDBClient:
    ...
    def __init__(self):
        ...
        self._config = {"host": "127.0.0.1", "port": "6667", "username": "root", "password": "root"}
    ...
    def connect(
        ...
        try:
            self._config = {"host": host, "port": port, "username": username, "password": password}
    ...
    def initialize_schema(self, storage_group: str = None, timeseries: str = None) -> bool:
        ...
        try:
            ...
            create_ts_sql = (
                f"CREATE TIMESERIES {full_ts_path} " f"WITH DATATYPE=INT32, ENCODING=PLAIN"
            )
